package com.github.bearcoding.forum.core.common;
    ...
    public static final Map<String, List<String>> HOMEPAGE_TOP_PIC_MAP = new HashMap<String, List<String>>() {
        {
            ...
            put(CATEGORY_BIG_DATA, new ArrayList<String>() {
                {
                    ...
                    add("https://cdn.tobebetterjavaer.com/bearcoding/1217d3dd677d91cb65b0cc85769f7f3d.jpg");
                    add("https://cdn.tobebetterjavaer.com/bearcoding/5de37f5c879543bd17f031f4243fae7d.jpg");
                }
            });
            put(CATEGORY_INTELLIGENCE, new ArrayList<String>() {
                {
                    add("https://cdn.tobebetterjavaer.com/bearcoding/077b7d8891e69701e8d3d4302392dab5.jpg");
                    add("https://cdn.tobebetterjavaer.com/bearcoding/be98a2779d2dde96c40092bbae958864.jpg");
                    add("https://cdn.tobebetterjavaer.com/bearcoding/d368d4bed7daf51116f4defbb4afcb6d.jpg");
                    add("https://cdn.tobebetterjavaer.com/bearcoding/c6bfe6bea326a64a267520ba7cada539.jpg");
                }
            });
            ...
            put(CATEGORY_TOOL, new ArrayList<String>() {
                {
                    add("https://cdn.tobebetterjavaer.com/bearcoding/53de05a01c7246feadffb6ba24120416.jpg");
                    add("https://cdn.tobebetterjavaer.com/bearcoding/e3e1f7a729d5cfbde0e5373c2d61377a.jpg");
                    add("https://cdn.tobebetterjavaer.com/bearcoding/326585eab30c33cdfa1cc058b269bf5a.jpg");
                    add("https://cdn.tobebetterjavaer.com/bearcoding/870997d1442e4d67186bf0dbc52e2096.jpg");
                }
            });
            put(CATEGORY_READ, new ArrayList<String>() {
                {
                    add("https://cdn.tobebetterjavaer.com/bearcoding/dd3f3e90b666cfe65f4ca5e56ebfc9f8.jpg");
                    add("https://cdn.tobebetterjavaer.com/bearcoding/7c591a44a9f83eec9606d16f89040632.jpg");
                    add("https://cdn.tobebetterjavaer.com/bearcoding/42dbb88fed8caa2d95860dbdb359c18f.jpg");
                    add("https://cdn.tobebetterjavaer.com/bearcoding/b99cab7999d5bdf3f5926dc0a98d02da.jpg");
                }
            });
        }
    };
