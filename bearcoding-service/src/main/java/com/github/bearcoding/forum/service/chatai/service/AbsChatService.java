...
import com.github.bearcoding.forum.service.chatai.constants.ChatConstants;
...
public abstract class AbsChatService implements ChatService {
    ...
    public ChatRecordsVo getChatHistory(Long user, AISourceEnum aiSource) {
        ...
        chats.add(0, new ChatItemVo().initAnswer(String.format("开始你和Smartbear(%s-大模型)的AI之旅吧!", aiSource.getName())));
