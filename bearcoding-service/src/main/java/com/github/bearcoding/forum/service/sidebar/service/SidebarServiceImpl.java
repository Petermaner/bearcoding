...
import com.github.bearcoding.forum.api.model.enums.SidebarStyleEnum;
...
import com.github.bearcoding.forum.api.model.vo.recommend.RateVisitDTO;
import com.github.bearcoding.forum.api.model.vo.recommend.SideBarDTO;
import com.github.bearcoding.forum.api.model.vo.recommend.SideBarItemDTO;
...
import com.github.bearcoding.forum.service.config.service.ConfigService;
...
public class SidebarServiceImpl implements SidebarService {
    ...
    private SideBarDTO noticeSideBar() {
        ...
        return new SideBarDTO()
                .setTitle("关于技术派")
                // TODO 知识星球的
                .setImg("https://cdn.tobebetterjavaer.com/bearcoding/main/bearcoding-zsxq.jpg")
                .setUrl("https://bearcoding.com/article/detail/2422000009961473")
                .setItems(items)
